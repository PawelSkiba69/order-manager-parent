...
/**
 * &lt;p&gt;Java class for terminRodzajType.
 * 
 * &lt;p&gt;The following schema fragment specifies the expected content contained within this class.
 * &lt;pre&gt;
 * &amp;lt;simpleType name="terminRodzajType"&amp;gt;
 ...
 *     &amp;lt;enumeration value="BEZPOSREDNI_DO_30KG"/&amp;gt;
...
public enum TerminRodzajType {
    ...
    @XmlEnumValue("BEZPOSREDNI_DO_30KG")
    ...
    public static TerminRodzajType fromValue(String v) {
        for (TerminRodzajType c: TerminRodzajType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
