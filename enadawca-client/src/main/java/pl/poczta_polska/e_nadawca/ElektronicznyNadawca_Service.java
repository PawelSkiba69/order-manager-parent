        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElektronicznyNadawca_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/pawelskibol/Desktop/Project/order-manager-full/order-manager-parent/enadawca-client/src/main/resources/en.wsdl");
        }
        WSDL_LOCATION = url;
    }
