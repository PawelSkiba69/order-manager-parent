...
class ENadawcaManagerTest {
    ...
    void checkStatus() throws DatatypeConfigurationException {
        ...
        //WHEN
        List<ShipmentConfirmationModel> shipmentConfirmationModels = eNadawcaManager.checkStatus(orderModels, guids,
                LocalDateTime.of(2020, 4, 20, 0, 0), LocalDateTime.now());
        //THEN
    }
